...
{!! Form::open(
	array('url'=>'revolution/estudios','method'=>'POST','autocomplete'=>'off')) !!}
				...
				<tbody>
					<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<tr>
							...
							<td><input type="text" name="evaluado" class="form-control"></td>
						</tr>
						<tr>
							<td style="width: 25%;">Puesto:</td>
							<td><input type="text" name="puestoSolicitado" class="form-control"></td>
						</tr>
						<tr>
							<td style="width: 25%;">Fecha de solicitud:</td>
							<td><input type="text" name="fechaEvaluacion" class="form-control"></td>
						</tr>
						<tr>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<tbody>
					<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<tr>
							<td>
								<textarea class="form-control" rows="7" cols="60"></textarea>
							</td>
						</tr>
					</table>
				</tbody>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<tbody>
					<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<tr>
							<td style="width: 15%;">
								<label>Deshonestidad</label> <input type="checkbox" value="deshonestidad" name="deshonestidad" class="checkbox-inline">
							</td>
							<td style="width: 15%;">
						...
						<tr>
							<td style="width: 15%;">
								<label>Adicciones sexual <input type="checkbox" value="adicciones" name="adicciones" class="checkbox-inline"></label>
							</td>
						</tr>
						<tr>
							<td style="width: 15%;">
								<label>Perversion sexual <input type="checkbox" value="perversion" name="perversion" class="checkbox-inline"></label>
							</td>
						</tr>
						<tr>
							<td style="width: 15%;">
								<label>Inestabilidad emocional <input type="checkbox" value="InestabilidadEmo" name="InestabilidadEmoci" class="checkbox-inline" value="1"></label>
							</td>
						</tr>
				</tbody>
			</table>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				<tbody>
					<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<tr>
							<td style="width: 25%;">Nombre del evaluado:</td>
							<td><input type="text" name="evaluado" class="form-control"></td>
						</tr>
						<tr>
							<td style="width: 25%;">Puesto solicitado:</td>
							<td><input type="text" name="puestoSolicitado" class="form-control"></td>
						</tr>
						<tr>
							<td style="width: 25%;">Fecha de evaluacion:</td>
							<td><input type="text" name="fechaEvaluacion" class="form-control"></td>
						</tr>
					</table>
				</tbody>
				...
				<tbody>
					<table class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<tr>
							...
							<td><input type="text" name="fechaNacimiento" class="form-control"></td>
						</tr>
						<tr>
							<td style="width: 25%;">Giro de la Empresa:</td>
							<td><input type="text" name="giro" class="form-control"></td>
						</tr>
						<tr>
