...
<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-6 col-xs-12"> 
			<h3 style="font-size:20px;">Inicio de Analista de Revolution</h3>
		</div>
</div>		
						...
						<tr>
							...
							<td style="text-align: justify;"><br><br>
                        		...
                        		<tr>
                        			...
                        			<a href="{{URL::action('AnalistaController@edit',array($datos->ID_analista,'procedencia'=>$procedencia))}}"><button class="btn btn-primary">Editar</button>
                        				</a>
                        			</td>
                        		</tr>
                        	</td>
