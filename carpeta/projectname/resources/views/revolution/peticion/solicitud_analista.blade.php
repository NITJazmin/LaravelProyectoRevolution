					...
					@foreach($solicitud as $sol)
						<tr>	
							...
							<td>
								...
								<a href="{{URL::action('EstudiosController@show',['id'=>$sol->ID_peticion,'procedencia'=>$procedencia='sol_pdf'])}}">
								 	<button class="btn" style="background-color: brown; color: white;">Ver PDF</button>
								 </a>
							</td>
